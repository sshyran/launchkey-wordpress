...
class LaunchKey_WP_SSO_Client_Still_Authenticated_Heartbeat_Test extends LaunchKey_WP_SSO_Client_Test_Abstract {
	 ...
	 */
	public function test_does_not_logout_if_user_did_not_auth_with_launchkey() {
	 ...
	 * @depends test_gets_the_current_user_and_checks_their_status
	 */
	public function test_does_not_logout_or_redirect_if_user_authed_with_launchkey_and_still_authenticated() {
		Phake::when( $this->facade )->is_user_logged_in()->thenReturn( true );
